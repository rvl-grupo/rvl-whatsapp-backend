...
function testContactCreation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { data: newChat, error: chatError } = yield supabase
                .schema('operacao')
                .from('chats')
                .insert({
            ...
            const { data: newContact, error: contactError } = yield supabase
                .schema('crm')
                .from('contacts')
            ...
            if (contactError) {
                ...
                yield supabase.schema('operacao').from('chats').delete().eq('id', newChat.id);
                return;
            }
            console.log('\n✅ ========================================');
            ...
            const { data: contacts, error: listError } = yield supabase
                .schema('crm')
                .from('contacts')
                .select('*')
                .eq('id', newContact.id);
